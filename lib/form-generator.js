...
class FormGenerator {
    ...
    static addTooltips(text) {
        return text.replace(/!{[\s\S]*}{[\s\S]*}/gi, function (match) {
            ...
            return `<span style="cursor:default; border-bottom: 1px dotted #000;" data-tippy="${tooltipText}">${mainText}<sup>&#x1f6c8;</sup></span>`;
        });
    }
    ...
    static transformBranch(org, project, page, val, parent, attrs, inBox, key) {
