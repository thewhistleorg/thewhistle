...
describe('Report app'+' ('+app.env+')', function() {
    ...
    describe('submitted report in admin app', function() {
        ...
        it('sees new report with nicely formatted information', async function() {
            ...
            expect(ths[3].textContent).to.equal('Description');
            expect(ths[3].nextSibling.textContent).to.equal('Test');
            expect(ths[4].textContent).to.equal('Where');
            expect(ths[4].nextSibling.textContent).to.equal('University of Lagos');
            expect(ths[5].textContent).to.equal('Who');
    ...
    describe('single page report in admin app', function() {
        it('sees new report with nicely formatted information', async function() {
            ...
            expect(ths[2].nextSibling.textContent).to.equal('no');
            expect(ths[3].textContent).to.equal('Description');
            expect(ths[3].nextSibling.textContent).to.equal('Single-page submission test');
            expect(ths[4].textContent).to.equal('Where');
            expect(ths[4].nextSibling.textContent).to.equal('University of Lagos');
            expect(ths[5].textContent).to.equal('Who');
            expect(ths[5].nextSibling.textContent).to.equal('Not known: A death eater');
