 ...
 *
 * The input labels are obtained from global.forms, as set up by FormGenerator.build().
 *
 * Since radio buttons / checkboxes with no value selected don't appear in post data, the processing
 * is driven by the global.forms (which is generated by FormGenerator.build on first request to
