...
class FormGenerator {
    ...
    static transformBranch(org, project, page, val, parent, attrs, inBox) {
        ...
        ret += FormGenerator.transformBody(org, project, page, val.branch.body, parent) + '\n';
                ...
                for (const [ key, val ] of Object.entries(input.options)) {
                    ...
                    if (val.branch) {
                        if (val.branch['in-box']) {
                            html += FormGenerator.transformBranch(org, project, page, val, parent, attrs, true) + '</li>\n';
                        } else {
                            html += '</li>\n' + FormGenerator.transformBranch(org, project, page, val, parent, attrs, false);
                        }
                    } else {
                        html += '</li>\n';
                    }
