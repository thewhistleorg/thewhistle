...
describe(`Submit ${org}/${proj} incident (from form spec in db)`, function () {
    ...
    it('sees & deletes report in admin', function() {
        ...
        cy.get('table.js-obj-to-html').then(($table) => {
            ...
            const expected = {
                'Alias':                                             alias,
                'Consent to record?o':                               'Yes',
                'Name of person filling out formT':                  'Da boss',
                'OrganisationT':                                     'HFRN',
                'Organisation referenceT':                           '—',
                'Contact detailsT':                                  '—',
                'Name of person giving statementT':                  'Alice',
                // TODO: 'What date did the incident occur?':           dateFormat('d mmm yyyy'),
                'LocationT':                                         'Around the corner',
                'Did this incident happen to you?o':                 'Yes - This incident happened to me',
                'DescriptionT':                                      'Cypress test '+date,
                'Type of incidento':                                 '—',
                'Who is the perpetrator?o':                          '—',
                'Form of violenceo':                                 '—',
                'Reported?o':                                        '—',
                'Medical attention required?o':                      '—',
                'Did the incident involve an unaccompanied minor?o': '—',
                'Consent to being contacted?o':                      '—',
                'Consent to media testimony?o':                      '—',
                'Consent to information?o':                          'Yes',
            };
